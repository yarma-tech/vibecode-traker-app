...
ajouter, et jamais d'autres : les titres des features d'un PRD, et - plus
tard - la phrase d'un verdict de vérification. Ni code, ni diff, ni prompt,
ni secret : aucune table n'a de colonne où l'un d'eux pourrait entrer.
